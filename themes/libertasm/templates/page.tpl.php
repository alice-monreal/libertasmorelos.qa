...
<div id="page-wrapper"><div id="page">
  ...
  <div id="header" class="<?php print $secondary_menu ? 'with-secondary-menu': 'without-secondary-menu'; ?>"><div class="section clearfix">
    ...
    <?php if ($site_name || $site_slogan): ?>
      ...
      <a href="<?php echo $url_site ?>"> <div class="site_logo"> </div> </a>
    <?php endif; ?>
    ...
    <?php 
        // $query = "SELECT A.nid, A.vid, A.uid, A.type, A.status, A.title, B.field_add_type_value, C.field_add_sections_value  
        //                 FROM {node} A 
        //                 INNER JOIN {field_data_field_add_type} B ON A.nid = B.entity_id 
        //                 WHERE A.status = 1
        //                   AND B.field_add_type_value like '%:type%'
        //                 ORDER BY A.nid DESC LIMIT 1";
        // $adds = db_query($query, array(':type' => 'vertical', ':section' => '107'))->fetchAll();
        // print_r($adds);
    ?>
    ...
    <div id="content" class="column"><div class="section">
      ...
      <?php
        ...
        if($content_type == "articulo"){
          ...
          //Portada
          // Cover Title
          $cover_title = $content["body"]["#object"]->title;
          // Cover Description
          $cover_description = $content["body"]["#object"]->field_description["und"][0]["value"];
          // Cover Position
          $cover_position = $content["#node"]->field_cover_position["und"][0]["value"];

          //Artículo
          // Title
          $title = $content["body"]["#object"]->field_title["und"][0]["value"]; //encabezado
          // Author
      ...
      ?>
          ...
          <a class='fancybox-button' rel='fancybox-button' href="<?php print $cover?>" title=''>
            <div class="article_cover_container" style="background-image: url('<?php print $cover?>'); background-position: <?php print $cover_position ?>;">
          ...
          <div class="article_container">
            <a href='http://www.uaem.mx/' target='_blank'>
              <div class="article_adds" id="article_publicidad_vertical">
                <!-- <p> Publicidad </p> -->
              </div>
            </a>
      ...
      <?php
        ...
        elseif($content_type == "opinion"){
          ...
          // Cover Position
          $cover_position = $content["#node"]->field_opinion_cover_position["und"][0]["value"];
          
          //Opinión
          // Title
          $title = $content["#node"]->field_opinion_title["und"][0]["value"]; //encabezado
          // Author
      ...
      ?>
          ...
          <div class="article_container">
            <a href='http://jardinesdemexico.com/' target='_blank'>
              <div class="article_adds" id="opinion_publicidad_vertical">
                <!-- <p> Publicidad </p> -->
              </div>
            </a>
            <p class="ac_title"> <?php print $title; ?> </p>
          ...
          ?>
            ...
            <div class='lista_section'>
              ...
              <div class='lista_container'>
                <a href='<?php echo $list['href'] ?>' target='_blank'>
                  <div class="lista_adds" id="<?php echo $list['id'] ?>">
                    <!-- <p> Publicidad </p> -->
                  </div>
                </a>
